...
//   if (loading) {
//     return (
//       <div className="container mx-auto p-2 flex items-center justify-center min-h-[300px]">
...
//   return (
//     <div className="container mx-auto min-h-[70vh] flex items-start justify-center p-2 sm:p-4">
...
//           <div className="border-t border-b py-3 my-2 grid grid-cols-2">
